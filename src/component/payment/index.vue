      ...
      <div class="col-75">
        <div class="container">
          <form class="needs-validation" v-on:submit="submitPayment">
              ...
              <div class="col-50">
                ...
                <div class="row">
                  ...
                  <div class="col-50">
                    ...
                    <input type="number" id="cvv" name="cvv" placeholder="333">
                  </div>
                </div>
              </div>
            ...
            <input type="text" class="form-control" id="paymentMethod" placeholder="Nhập phương thức" v-model="PaymentMethod">
          </div>
